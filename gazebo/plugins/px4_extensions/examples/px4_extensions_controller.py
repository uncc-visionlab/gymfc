...
if __name__ == '__main__':
    #default_model = "../../../models/iris/model.sdf"
    default_model = "../../../models/iris_sttr/iris_sttr.sdf"
    #default_config = "../worlds/blast_test.ini"
    default_config = "../worlds/windy_uncc_engcampus.ini"
    ...
    gym.envs.register(
        id="gymfc_quadrotor_exts",
        entry_point='px4_extensions_controller:StepEnv',
        kwargs={
            "state_fn": state_fn_error,
        }
    )
    env = gym.make("gymfc_quadrotor_exts")
