...
namespace gazebo {
    ...
    void GazeboMotorModel::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
        ...
        command_sub_ = node_handle_->Subscribe<cmd_msgs::msgs::MotorCommand>(command_sub_topic_,
...
// This gets called by the world update start event.
    ...
    double GazeboMotorModel::CommandTransferFunction(double x) {
        return (esc_transfer_function_coeff_[0] * x * x) + (esc_transfer_function_coeff_[1] * x) +
               esc_transfer_function_coeff_[2];
    }
