...
class GazeboMessageHandler:
    """
    General idea is that the distance between all the aircraft subcomponents should be the same.
    ...
    async def connect(self):
        try:
            ...
            self.pose_subscriber = self.manager.subscribe('/gazebo/default/pose/info', 'gazebo.msgs.PosesStamped',
                                                          self.pose_callback)
